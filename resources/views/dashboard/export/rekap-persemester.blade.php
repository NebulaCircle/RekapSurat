    ...
    <table border="1">
        ...
        <tr>
            ...
            <th style="font-size:13px;text-align: center;vertical-align: middle;font-weight:bold;border: 5px solid black"
                rowspan="3" colspan="10">Induk </th>
            <th style="font-size:13px;text-align: center;vertical-align: middle;font-weight:bold;border: 5px solid black"
                rowspan="3" colspan="10">Nama
                Siswa</th>
            <th style="font-size:13px;text-align: center;vertical-align: middle;font-weight:bold;border: 5px solid black"
                rowspan="3" colspan="4">L/P</th>
            {{-- <th colspan="{{ $d }}"
        ...
        <tr>
            ...
            @endfor --}}
            <th style="font-size:13px;width: 2px;text-align: center;font-weight:bold;border: 5px solid black">SAKIT</th>
            <th style="font-size:13px;width: 2px;text-align: center;font-weight:bold;border: 5px solid black">IJIN</th>
            <th style="font-size:13px;width: 2px;text-align: center;font-weight:bold;border: 5px solid black">ALPA</th>
            <th style="font-size:13px;width: 2px;text-align: center;font-weight:bold;border: 5px solid black">TERLAMBAT</th>
        </tr>
        ...
        @foreach ($siswa as $s)
            <tr>
                ...
                <td colspan="5" style="min-width: 200px;max-width:250px;border: 5px solid black">
                    {{ $s->nisn }}
                </td>
                <td colspan="10" style="min-width: 200px;max-width:250px;border: 5px solid black">
                    {{ $s->nama_lengkap }}</td>
                <td colspan="2" style="min-width: 200px;max-width:250px;border: 5px solid black">
                    {{ $s->jk }}
                </td>
