...
!(function (t, e) {
            ...
            e &&
                ...
                u(n, (e) => {
                    const n = e.options,
                        ...
                        r = l(n.type, e.dtype);
                    (void 0 !== n.position &&
                        gn(n.position, a) === gn(e.dposition)) ||
            ...
            const n = (function (t, e) {
                ...
                for (
                    ...
                    (u && M !== a
                        ? (i.push({ value: a }),
                          M < a && D++,
                          V(Math.round((M + D * S) * v) / v, a, ro(a, y, t)) &&
                              D++)
                        : M < a && D++);
                    D < k;
                    ++D
            ...
            return (
                ...
                (this._majorUnit =
                    i.major.enabled && "year" !== this._unit
                        ? (function (t) {
                              for (
                                  let e = Do.indexOf(t) + 1, i = Do.length;
                                  e < i;
                                  ++e
                              )
    ...
    var la = {
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < s; ++a)
                (l = n[a]),
                    l && !1 !== l.fill && (l.fill = Zo(n, a, i.propagate));
        },
        beforeDraw(t, e, i) {
    ...
    class Aa extends Bs {
        ...
        getTitle(t, e) {
            ...
            let a = [];
            return (
                (a = xa(a, _a(s))), (a = xa(a, _a(n))), (a = xa(a, _a(o))), a
            );
        }
        getBeforeBody(t, e) {
